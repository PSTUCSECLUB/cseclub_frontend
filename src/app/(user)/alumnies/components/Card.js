...
//         <Avatar size="lg" src={alumni.photo} sx={{ borderRadius: "sm" }} />
//         <Box>
//           <Typography>{alumni.name}</Typography>
//           <Typography level="body3">Session: {alumni.session}</Typography>
//         </Box>
//       </Box>
//       <Divider component="div" sx={{ my: 2, p: 0 }} />
//       <List>
//         <ListItem sx={{ alignItems: "flex-start" }}>
//           <Avatar sx={{ mr: 1 }} size="sm" src="/icons/position.svg" />

//           <ListItemContent>
//             <Typography fontSize="sm">
//               {alumni.jobRole ? alumni.jobRole : "Unknown"}
//             </Typography>
//             <Typography level="body3">
//               {alumni.jobCompany ? alumni.jobCompany : "Unknown"}
//             </Typography>
//           </ListItemContent>
//         </ListItem>
//       </List>

//       {Object.keys(alumni.socialLinks).length > 0 &&
//       !checkEmpty(alumni.socialLinks) ? (
//         <>
//           <Divider component="div" sx={{ my: 2 }} />
//           <Typography fontSize="sm">Online Presences :</Typography>
//           <Box sx={{ mt: 1.5, display: "flex", gap: 1, flexWrap: "wrap" }}>
//             {alumni.socialLinks.facebook && (
//               <Link href={alumni.socialLinks.facebook}>
//                 <Chip
//                   startDecorator={<Avatar src="/icons/facebook.svg" />}
//                   variant="plain"
//                   color="neutral"
//                   size="sm"
//                   sx={{ borderRadius: "sm", cursor: "pointer" }}
//                 >
//                   Facebook
//                 </Chip>
//               </Link>
...
//               <Link href={alumni.socialLinks.twitter}>
//                 <Chip
//                   startDecorator={<Avatar src="/icons/twitter.svg" />}
//                   variant="plain"
//                   color="neutral"
//                   size="sm"
//                   sx={{ borderRadius: "sm", cursor: "pointer" }}
...
//               <Link href={alumni.socialLinks.linkedin}>
//                 <Chip
//                   startDecorator={<Avatar src="/icons/linkedin.svg" />}
//                   variant="plain"
//                   color="neutral"
//                   size="sm"
//                   sx={{ borderRadius: "sm", cursor: "pointer" }}
  ...
  return (
    ...
    >
      <CardContent sx={{ alignItems: "center", textAlign: "center" }}>
        <Avatar src={alumni.photo} sx={{ "--Avatar-size": "6rem" }} />
        <Chip
          size="sm"
          variant="soft"
          color="primary"
        ...
        <Typography level="body2" sx={{ maxWidth: "24ch" }}>
          {alumni.jobRole} at {alumni.jobCompany}
        </Typography>
        <Box
          sx={{
            display: "flex",
